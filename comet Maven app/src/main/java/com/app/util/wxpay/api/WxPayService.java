package com.app.util.wxpay.api;

import com.alibaba.fastjson.JSONObject;
import com.app.util.pay.api.BasePayService;
import com.app.util.pay.api.Callback;
import com.app.util.pay.api.PayConfigStorage;
import com.app.util.pay.bean.*;
import com.app.util.pay.bean.result.PayException;
import com.app.util.pay.exception.PayErrorException;
import com.app.util.pay.http.HttpConfigStorage;
import com.app.util.pay.util.MatrixToImageWriter;
import com.app.util.pay.util.sign.SignUtils;
import com.app.util.pay.util.str.StringUtils;
import com.app.util.wxpay.bean.WxPayError;
import com.app.util.wxpay.bean.WxTransactionType;
import com.app.util.pay.util.XML;
