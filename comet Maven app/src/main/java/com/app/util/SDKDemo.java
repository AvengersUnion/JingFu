...
//
	...
	public static void singleSend(SmsSendConn smsSendConn, String userid) {
		try {
			...
			// 设置手机号码 此处只能设置一个手机号码
			message.setMobile("13012982833");
			// 设置内容
			message.setContent("您的验证码是{w1-8}，在{d1-3}分钟内有效。如非本人操作请忽略本短信。");
			// 设置扩展号
			message.setExno("11");
			// 用户自定义流水编号
	...
	public static void batchSend(SmsSendConn smsSendConn, String userid) {
		try {
			...
			message.setUserid(userid);
			// 设置手机号码
			message.setMobile("13012982833,13012982833");
			// 设置内容
	...
	public static void multiSend(SmsSendConn smsSendConn, String userid) {
		try {
			...
			// 手机号
			multixMt1.setMobile("13012982833");
			// 短信内容
			...
			// 手机号
			multixMt2.setMobile("13012982833");
			// 短信内容
