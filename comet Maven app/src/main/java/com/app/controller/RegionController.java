...
public class RegionController {
	...
	public List getRegionList() {
		...
		for (int i = 0; i < listRegions.size(); i++){
			...
			List<Region> managerList=regionService.getManagersByPostcode(listRegions.get(i).getPostcode());
	...
	public String addmanager(String postcode,String uname,String passWord) {
		if (null==postcode||postcode.equals("")||null!=regionService.getManangerByName(uname)) {
			return "0";
		}else {
			//添加manger表的数据
	...
	public String deleteManager(String managerId) {
		if (null!=managerId&&null!=regionService.getManagerById(managerId)) {
